...
class MutualzzRpc extends node_events.EventEmitter {
    constructor(options){
    ...
    connectPath(path) {
        return new Promise((resolve, reject)=>{
            const socket = net__default.default.createConnection(path);
...
exports.MAX_IPC_SLOTS = MAX_IPC_SLOTS;
exports.MutualzzRpc = MutualzzRpc;
exports.OPCODE_CLOSE = OPCODE_CLOSE;
exports.OPCODE_FRAME = OPCODE_FRAME;
exports.OPCODE_HANDSHAKE = OPCODE_HANDSHAKE;
exports.OPCODE_PING = OPCODE_PING;
exports.OPCODE_PONG = OPCODE_PONG;
exports.encodeFrame = encodeFrame;
exports.pipePath = pipePath;
